-- Add confirmation tracking columns to user_assignments table
-- This allows tracking when documents assigned to users have been confirmed/acknowledged
...
-- Add index for unconfirmed assignments (commonly queried)
...
-- Create a view for assignments requiring confirmation
...
-- Create a view for confirmed assignments report
...
-- Add RLS policies for the views (they inherit from user_assignments)
...
-- Create a function to mark an assignment as confirmed
...
-- Create a function to check if a user has pending confirmations
