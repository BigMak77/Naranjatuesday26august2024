-- Migration: Update sync function to set auto_assigned_from_module column
-- This replaces the previous sync_module_document_assignments function to include tracking
...
COMMENT ON FUNCTION sync_module_document_assignments(UUID, UUID) IS
  'Manually sync document assignments for module assignments.
   ...
   Sets auto_assigned_from_module to track which module created each assignment';
