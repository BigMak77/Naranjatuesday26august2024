...
export default function PrivacyPage() {
  ...
  const showChildrenSection = false;
  const showInternationalTransfers = true;
  const processorsSummary = "cloud hosting, analytics, email delivery, and payment processing";
  const lawfulBases = ["consent", "contract", "legal_obligation", "legitimate_interests"] as Array<LawfulBase>;
