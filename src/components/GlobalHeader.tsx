...
export default function GlobalHeader({ logoOnly = false }: GlobalHeaderProps) {
  ...
  return (
    <div
      className="global-logo-header-rows"
      style={{
        position: "relative",
        width: "100vw",
        left: "50%",
    ...
    >
      ...
      >
        ...
        >
          ...
          {!user?.auth_id && (
            <div className="user-profile-card user-profile-card-placeholder">
              Not logged in
            </div>
          )}
          {!loading && !user && (
      ...
      <div
        className="global-header-second-row"
        style={{
          width: "100%",
          minHeight: "40px",
          display: "flex",
