    ...
    <>
      <section className="section-toolbar neon-toolbar" style={{ zIndex: 20, position: 'relative' }}>
        <div className="inner" style={{ display: "flex", alignItems: "center", gap: 16, padding: "0.5rem 0", width: "100%", justifyContent: "flex-start" }}>
          ...
          <button className="neon-btn neon-btn-square" aria-label="Manage Training Modules" onClick={() => window.location.href = '/admin/modules'}>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-layers neon-icon">
