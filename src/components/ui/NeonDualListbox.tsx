...
export default function NeonDualListbox({
  ...
  return (
    <NeonPanel
      className={`neon-panel neon-dual-listbox ${styles["neon-dual-listbox"]}`}
    >
        ...
        <div className={styles["neon-dual-listbox-panel"]}>
          ...
          <ul className={styles["neon-listbox"]}>
            {available.map((item) => (
              <li
                key={item.id}
                className={`${styles["neon-listbox-item"]}${highlightedLeft.includes(item.id) ? " " + styles["neon-listbox-item-selected"] : ""}`}
                onClick={() =>
        ...
        <div className={styles["neon-dual-listbox-panel"]}>
          ...
          <ul className={styles["neon-listbox"]}>
            {selectedItems.map((item) => (
              <li
                key={item.id}
                className={`${styles["neon-listbox-item"]}${highlightedRight.includes(item.id) ? " " + styles["neon-listbox-item-selected"] : ""}`}
                onClick={() =>
