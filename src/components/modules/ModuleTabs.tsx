...
const tabList = [
  { key: 'overview', label: 'Overview', value: 'Overview', icon: <span className="inline-block"><svg width="20" height="20" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></svg></span> },
  { key: 'edit', label: 'Edit', value: 'Edit', icon: <span className="inline-block"><svg width="20" height="20" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/></svg></span> },
  { key: 'assign', label: 'Assign', value: 'Assign', icon: <span className="inline-block"><svg width="20" height="20" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 19v-7m0 0l-3.5 3.5M12 12l3.5 3.5"/></svg></span> },
  { key: 'assignments', label: 'Assignments', value: 'Assignments', icon: <span className="inline-block"><svg width="20" height="20" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="7" r="4"/><path d="M5.5 21a7.5 7.5 0 0 1 13 0"/></svg></span> },
  { key: 'history', label: 'History', value: 'History', icon: <span className="inline-block"><svg width="20" height="20" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></span> },
  { key: 'resources', label: 'Resources', value: 'Resources', icon: <span className="inline-block"><svg width="20" height="20" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h6v6H9z"/></svg></span> }
]
      ...
      <NeonPanel className="neon-panel-module mt-4">
        {activeTab === 'Overview' && (
          <>
            ...
            {onEdit && <NeonIconButton variant="edit" icon={<FiEdit color="white" />} title="Edit Module" onClick={onEdit} className="mt-6" />}
            {onCancel && (
              <NeonIconButton
                variant="cancel"
